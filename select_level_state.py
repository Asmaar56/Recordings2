...
class SelectLevelState(IAppState):
    ...
    def start(self):  # called when this state first appears
        ...
        level_1_button_pos_rect = pygame.Rect(0, 0, 150, 40)
        ...
        return_to_main_menu_button_pos_rect.top = level_1_button_pos_rect.bottom + 20
