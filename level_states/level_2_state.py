...
class Level2State(IAppState):
    ...
    def __init__(self,
        ...
        self.level = 2  # what level is this
    ...
    def start(self):  # called when state starts up
        ...
        self.background_texture = pygame.transform.smoothscale(
            pygame.image.load('level_states/game_images/level_2_image.jpg').convert(),
            self.world_bounds)
    ...
    def process_event(self, event: pygame.event.Event):
        ...
        if event.type == pygame.KEYDOWN:  # if any keyboard key is pressed
            if event.key == pygame.K_p:  # return to menu
                ...
                print('KEY P pressed in LEVEL2STATE')
